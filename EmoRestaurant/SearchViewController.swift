...
class SearchViewController: UIViewController, UISearchBarDelegate {
    ...
    override func viewDidLoad() {
        ...
        setupWeatherStepper()
        setupPeopleStepper()
        pickOneButton.setStyle(borderWidth: 1.0, borderColor: UIColor.blueColor().CGColor, backgroundColor: UIColor.blueColor(), titleColor: UIColor.whiteColor())
    }
    ...
    private func getBestRestaurant(happiness happiness: Double, weather: Double, people: Double) {
                ...
                if let result = data as? [PFObject] {
                    ...
                    for restaurant in result {
                        if let feature = restaurant.valueForKey(Database.Feature) as? [Double] {
                            let distance = self.computeDistance(feature1: feature, feature2: [happiness, weather, people])
    ...
    private func computeDistance(feature1 feature1: [Double], feature2: [Double]) -> Double? {
