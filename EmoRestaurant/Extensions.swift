...
extension UITextView {
    func setStyle(borderWidth borderWidth: CGFloat, borderColor: CGColor) {
...
extension UIButton {
    func setStyle(borderWidth borderWidth: CGFloat, borderColor: CGColor, backgroundColor: UIColor, titleColor: UIColor) {
        self.layer.borderWidth = borderWidth
        self.layer.borderColor = borderColor
...
extension UIStepper {
    func configure(mininumValue mininumValue: Double, maximumValue: Double, stepValue: Double, initialValue: Double) {
