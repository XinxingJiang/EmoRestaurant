...
class WriteCommentViewController: UIViewController, UITextViewDelegate {
    ...
    override func viewDidLoad() {
        ...
        setupWeatherStepper()
        setupPeopleStepper()
        submitButton.setStyle(borderWidth: 1.0, borderColor: UIColor.blueColor().CGColor, backgroundColor: UIColor.blueColor(), titleColor: UIColor.whiteColor())
    }
    ...
    @IBAction func submit() {
        ...
        let comment = PFObject(className: Database.Comment)
