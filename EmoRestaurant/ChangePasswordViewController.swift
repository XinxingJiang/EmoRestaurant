...
class ChangePasswordViewController: UIViewController, UITextFieldDelegate {
    ...
    @IBAction func save() {
        ...
        if newPassword == "" {
            let alert = UIAlertController(title: "Error!", message: "New password can not be empty.", preferredStyle: UIAlertControllerStyle.Alert)
                ...
                if error == nil {
                    ...
                    self.currentUser?.saveInBackgroundWithBlock() { (_, error) in
                        ...
                        if error == nil {
                            ...
                            let alert = UIAlertController(title: "Error!", message: Error.NetworkErrorMessage, preferredStyle: UIAlertControllerStyle.Alert)
                            alert.addAction(UIAlertAction(title: "Back", style: .Cancel, handler: nil))
                            self.presentViewController(alert, animated: true, completion: nil)
                            self.reset()
                        }
                    ...
                    let alert = UIAlertController(title: "Error!", message: "The password you gave is incorrect.", preferredStyle: UIAlertControllerStyle.Alert)
                    alert.addAction(UIAlertAction(title: "Back", style: .Cancel, handler: nil))
                    self.presentViewController(alert, animated: true, completion: nil)
                    self.reset()
                }
